...
<body>
  ...
  <div class="login-section">
    ...
    @csrf
    <input type="text" class="form-control mb-3" name="nombre" placeholder="Nombre" required value="{{ old('nombre') }}" />
    @error('nombre') <div class="text-danger">{{ $message }}</div> @enderror
    
    <input type="text" class="form-control mb-3" name="apellidos" placeholder="Apellidos" required value="{{ old('apellidos') }}" />
